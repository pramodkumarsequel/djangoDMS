    ...
    BootstrapDualListbox.prototype = {
      ...
      setBootstrap2Compatible: function(value, refresh) {
        ...
        if (value) {
          ...
          this.container.find('.moveall > i, .move > i').removeClass('icon-arrow-right').addClass('far fa-solid fa-angle-right font-w900 fs-4 text-black');
          this.container.find('.removeall > i, .remove > i').removeClass('icon-arrow-left').addClass('far fa-solid fa-angle-left font-w900 fs-4 text-black');
        }
        if (refresh) {
          refreshSelects(this);
        }
